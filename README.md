...
- **Ручное тестирование — сильная сторона.** Анализирую требования, составляю полную тестовую документацию: чек-листы, тест-кейсы, баг-репорты. В трёх проектах ниже — 290 проверок и 118 найденных дефектов.
...
| **[Stellar Burgers API](https://github.com/TatyanaKovalewa/stellar-burgers-api-testing)** | REST Assured, Step Objects: регистрация, авторизация, заказы | 20 | [Allure](https://tatyanakovalewa.github.io/stellar-burgers-api-testing/) |
...
| **[Яндекс.Прилавок](./manual-testing/yandex-prilavok/README.md)** | API сервиса доставки + Postman-коллекция | 109 | **60** |
